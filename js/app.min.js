(() => {
  ...
  let p = (e, t = !1, s = 500, i = 0) => {
    ...
    if (a) {
      ...
      if (
        (document.documentElement.classList.contains("menu-open") && o(),
  ...
  function m(e, t) {
    void 0 === e && (e = {}),
      ...
      Object.keys(t).forEach((s) => {
        void 0 === e[s]
          ? (e[s] = t[s])
          : u(t[s]) && u(e[s]) && Object.keys(t[s]).length > 0 && m(e[s], t[s]);
      });
  }
  const h = {
    body: {},
  ...
  var j = {
    ...
    updateSlides: function () {
      ...
      const s = e.params,
        ...
        c = L(a, `.${e.params.slideClass}, swiper-slide`),
      ...
      for (let i = 0; i < p; i += 1) {
        ...
        if (
          ((C = 0),
          c[i] && (a = c[i]),
          x && e.grid.updateSlide(i, a, c),
          !c[i] || "none" !== k(a, "display"))
        ) {
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              C = e.isHorizontal() ? O(a, "width", !0) : O(a, "height", !0);
            else {
              const e = t(r, "width"),
                s = t(r, "padding-left"),
                i = t(r, "padding-right"),
      ...
      if (
        ...
        x && e.grid.updateWrapperSize(C, u),
        !s.centeredSlides)
      ) {
        const t = [];
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        f && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)),
          N(l, f, s.slideVisibleClass),
          N(l, h, s.slideFullyVisibleClass),
          (l.progress = a ? -c : c),
      ...
      if (a.params.loop)
        if (a.virtual && a.params.virtual.enabled) n += a.virtual.slidesBefore;
          ...
          if (
            ...
            i && s && "auto" !== a.params.slidesPerView && !r && (l = !1),
            l)
          ) {
            const i = s
              ? e < a.activeIndex
  ...
  function Z(e) {
    ...
    let g = !0;
    l.matches(a.focusableElements) &&
      ((g = !1), "SELECT" === l.nodeName && (a.isTouched = !1)),
      s.activeElement &&
  ...
  function ee(e) {
    ...
    for (
      ...
      void 0 !== l[e + t]
        ? (m || (u >= l[e] && u < l[e + t])) && ((h = e), (f = l[e + t] - l[e]))
        : (m || u >= l[e]) &&
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const m = o.direction && o.direction !== i.direction,
            ...
            f = i.loop;
          m && s && e.changeDirection(), T(e.params, o);
  ...
  class ue {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = I(L(t, `.${s.slideClass}, swiper-slide`)[0]);
      return I(e) - i;
    }
  ...
  function he(e) {
    ...
    s({
      ...
      i("click", (e, s) => {
        ...
        (i = _(i)), (r = _(r));
        const n = s.target;
        let o = r.includes(n) || i.includes(n);
        if (t.isElement && !o) {
  ...
  function ge(e) {
    ...
    function p() {
      ...
      if (
        ...
        if (
          (s.dynamicBullets &&
            ((n = O(a[0], t.isHorizontal() ? "width" : "height", !0)),
            c.forEach((e) => {
  ...
  function ve(e) {
    let t,
      s,
      { swiper: i, extendParams: a, on: r, emit: n, params: o } = e;
    ...
    function b(e) {
      i &&
        ...
        g || (e.detail && e.detail.bySwiperTouchMove) || L());
    }
    const S = () => {
        if (i.destroyed || !i.autoplay.running) return;
        i.autoplay.paused ? (d = !0) : d && ((w = l), (d = !1));
        const e = i.autoplay.paused ? l : y + w - new Date().getTime();
            ...
            i &&
              ...
              (i.params.autoplay.reverseDirection
                ? !i.isBeginning || i.params.loop || i.params.rewind
                  ? (i.slidePrev(o, !0, !0), n("autoplay"))
                  : i.params.autoplay.stopOnLastSlide ||
                    (i.slideTo(i.slides.length - 1, o, !0, !0), n("autoplay"))
                : !i.isEnd || i.params.loop || i.params.rewind
                ? (i.slideNext(o, !0, !0), n("autoplay"))
                : i.params.autoplay.stopOnLastSlide ||
                  (i.slideTo(0, o, !0, !0), n("autoplay")),
              i.params.cssMode &&
                ((y = new Date().getTime()),
                requestAnimationFrame(() => {
                  T();
      ...
      C = (e, s) => {
        ...
        if (((i.autoplay.paused = !0), s))
          return m && (l = i.params.autoplay.delay), (m = !1), void a();
        const r = l || i.params.autoplay.delay;
        (l = r - (new Date().getTime() - y)),
          (i.isEnd && l < 0 && !i.params.loop) || (l < 0 && (l = 0), a());
      },
      L = () => {
  ...
  function be(e) {
    ...
    !(function (e) {
      ...
      setTransition: (e) => {
        const s = t.slides.map((e) => C(e));
        s.forEach((t) => {
          t.style.transitionDuration = `${e}ms`;
        }),
          ye({ swiper: t, duration: e, transformElements: s, allSlides: !0 });
      },
      overwriteParams: () => ({
        slidesPerView: 1,
        slidesPerGroup: 1,
  ...
  Object.keys(ce).forEach((e) => {
    ...
    window.addEventListener("load", function (e) {
      document.querySelector(".merch__slider") &&
        new ue(".merch__slider", {
          modules: [he, ge, ve],
          observer: !0,
          observeParents: !0,
          slidesPerView: 1,
          ...
          pagination: { el: ".merch__slider-pagination", type: "fraction" },
          navigation: {
        ...
        document.querySelector(".nft__slider") &&
          new ue(".nft__slider", {
            modules: [he, ve, be],
            observer: !0,
            observeParents: !0,
            ...
            loop: !0,
            navigation: {
              prevEl: ".nft__slider-button-prev",
              nextEl: ".nft__slider-button-next",
            },
            on: {},
          });
    });
  e.watcher = new (class {
    ...
    scrollWatcherLogging(e) {
      this.config.logging && l(`[Спостерігач]: ${e}`);
    }
  ...
  async function Te() {
    try {
      const e = "5LwseQRo8fsz4S3y7jbqqe5C7tZTz5PwhXNCHj13jLBi";
      ...
      (this.оbjects = []),
        ...
        this.mediaQueries.forEach((e) => {
          const t = e.split(","),
            ...
            i = t[1],
            a = this.оbjects.filter(({ breakpoint: e }) => e === i);
  ...
  const Ee = document.querySelector(".story__video-box");
  (Ee.onclick = () => {
    Ee.classList.contains("play")
      ? (Ee.classList.remove("play"), Ee.querySelector("video").pause())
      : (Ee.classList.add("play"), Ee.querySelector("video").play());
  }),
    (window.FLS = !1),
      ...
      if (e.length > 0) {
        ...
        function r(e, t = !1) {
          e.forEach((e) => {
            (e = t ? e.item : e),
              t.matches || !t
                ? (e.classList.add("_spoller-init"), n(e))
                : (e.classList.remove("_spoller-init"), n(e, !1));
          });
        }
        function n(e, t = !0) {
        ...
        function o(e) {
          ...
          if (
            ...
            const e = t.closest("summary"),
              a = e.closest("details"),
              r = e.closest("[data-spollers]"),
              n = r.hasAttribute("data-one-spoller"),
              o = a.hasAttribute("data-spoller-scroll"),
              d = r.dataset.spollersSpeed
            ...
            if (
              ...
              const e = a.dataset.spollerScroll,
                t = +e ? +e : 0,
                s = a.hasAttribute("data-spoller-scroll-noheader")
